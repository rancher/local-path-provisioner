...
| `image.tag`                             | Local Path Provisioner image tag                                                | `v0.0.37` .                                                                                                                                                                                                                                                                                                                                      |
...
| `storageClass.nodeAffinityKey`          | Node label key to use for the PV node affinity instead of `kubernetes.io/hostname` | `nil`                                                                                                                                                                                                                                                                                                                                         |
