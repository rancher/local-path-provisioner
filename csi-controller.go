...
func NewCsiController(ctx context.Context, kubeClient *clientset.Clientset,
	configFile, namespace, helperImage, configMapName, serviceAccountName, helperPodYaml string, allowUnsafeHelperPodTemplate bool) (*LocalPathCsiController, error) {
	...
	var err error
	csiController.helperPod, err = loadHelperPodFile(helperPodYaml, csiController.allowUnsafeHelperPodTemplate)
	if err != nil {
		return nil, err
	}
...
func (c *LocalPathCsiController) refreshHelperPod() error {
	...
	c.helperPod, err = loadHelperPodFile(newHelperPod, c.allowUnsafeHelperPodTemplate)
	if err != nil {
		return err
	}
